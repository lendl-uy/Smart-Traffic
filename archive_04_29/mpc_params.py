...
'''
S_1 = 500.79*(1/3600) # Saturation flow
S_2 = 500.93*(1/3600) # Saturation flow
S_3 = 500.93*(1/3600) # Saturation flow
S_4 = 500.14*(1/3600) # Saturation flow
'''
...
#xmax = np.array([300,300,500,500]) # (TUNABLE)
#xmax = np.array([10000,10000,10000,10000]) # (TUNABLE)
