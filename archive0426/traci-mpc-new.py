...
def main():
    ...
    for step in range(sim_duration+1):
        ...
        if step > 0:
            ...
            print("averageql", (ql_katip_south+ ql_katip_north+ ql_aurora_west+ ql_aurora_east)/4)
        fifteeenqueuelength,fifteenlen=perf.get_queue_length_15(new_stopped_vehs, 0, step,fifteenlen)
        if step%1800==0:
            
            temp_length15.append(fifteeenqueuelength)
            fifteenlen=0
        print("15lengthlist",temp_length15)
