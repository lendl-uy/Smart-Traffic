...
d_1 = np.array([1367.,1884.,1659.,1574.,1430.,1149.,1172.,886.,1074.,1451.,1292.,
                1432.,1082.,945.])
d_2 = np.array([2024.,2135.,1872.,2065.,2032.,1923.,1992.,1716.,1979.,2010.,2861.,
                2935.,2381.,2274.])
d_3 = np.array([1549.,1776.,1828.,1833.,1805.,1829.,1941.,1992.,2404.,2699.,2802.,
                3598.,3748.,3217.])
d_4 = np.array([4562.,4850.,5995.,3327.,2921.,2560.,2319.,4458.,3396.,3445.,3286.,
                3655.,3130.,2649.])
...
d_1p = poissonify(T,d_1[0]-d_1_out[0])
d_2p = poissonify(T,d_2[0]-d_2_out[0])
d_3p = poissonify(T,d_3[0]-d_3_out[0])
d_4p = poissonify(T,d_4[0]-d_4_out[0])
for i in range(1,len(d_1)):
  d_1p = np.append(d_1p, poissonify(T,d_1[i]-d_1_out[i]))
  d_2p = np.append(d_2p, poissonify(T,d_2[i]-d_2_out[i]))
  d_3p = np.append(d_3p, poissonify(T,d_3[i]-d_3_out[i]))
  d_4p = np.append(d_4p, poissonify(T,d_4[i]-d_4_out[i]))
